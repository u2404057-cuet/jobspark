        ...
        <div className="flex-1 flex flex-col min-h-0 bg-slate-950/30">
          <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6" ref={scrollRef}>
            ...
            {isStreaming && messages[messages.length - 1].role === 'user' && (
              <div className="flex gap-4 max-w-[85%] self-start">
                ...
                <div className="p-4 rounded-2xl bg-slate-800 text-slate-400 border border-slate-700/40 rounded-tl-none">
          ...
          <div className="p-4 bg-slate-900/60 border-t border-slate-800/80">
            <form onSubmit={sendMessage} className="flex gap-2 relative">
              ...
              <button 
                type="submit" 
                className="px-6 h-14 bg-primary text-white rounded-xl font-bold hover:opacity-90 active:scale-[0.99] transition-all shadow-md shadow-primary/20 disabled:opacity-50 flex items-center justify-center cursor-pointer"
